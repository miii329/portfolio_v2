              ...
              <div className={styles.concept_content}>
                <div className={styles.concept_content_left}>
                  ...
                  <p className={styles.concept_text}>
                    デザインも分かるエンジニアとして、アプリ・Web・LP制作のデザインから実装まで幅広く承っています。
                    <br />
            ...
            <SlideIn>
              <div className={styles.aboutme_content}>
                ...
                <div className={styles.aboutme_content_right}>
                  ...
                  <h3>私について</h3>
                  <p>
                    Web制作会社や広告制作会社で2年ほどWeb開発業務に従事し、現在は自社プロダクトの開発・改善に携わっています。アプリケーション開発だけでなく、データ分析や基盤周りなど、幅広いエンジニアリング業務に取り組んでいます。
                    <br />
                    <br />
                    Github:
                    <a
